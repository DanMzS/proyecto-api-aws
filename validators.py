...
def validar_profesor(payload: Dict[str, Any]) -> Tuple[bool, Dict[str, str]]:
    ...
    if 'numeroEmpleado' not in payload or not isinstance(payload['numeroEmpleado'], str) or not payload['numeroEmpleado'].strip():
        errores['numeroEmpleado'] = "El campo 'numeroEmpleado' es obligatorio y debe ser una cadena no vacía."
